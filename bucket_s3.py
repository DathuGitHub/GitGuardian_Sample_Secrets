...
def aws_upload(data: Dict):
    database = aws_lib.connect("AKIAF6DATHJKR45SAWSZ5", "abcdnk5ex5u34565AWS654/JKGjhz545d89sjkja")
    database.push(data)
...
MONGO_URI = "mongodb+srv://Dathuuser:pwdhub24aoeu@gg-is-awesome-gg273.mongodb.net/test?retryWrites=true&w=majority"
